              ...
              >
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input required className="w-full border border-black/15 bg-white py-4 pl-11 pr-4 outline-none focus:border-[#b58b32]" placeholder="Your name" />
                  </div>
                </div>
                <div className="grid gap-5 md:grid-cols-2">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input required type="email" className="w-full border border-black/15 bg-white py-4 pl-11 pr-4 outline-none focus:border-[#b58b32]" placeholder="you@email.com" />
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input className="w-full border border-black/15 bg-white py-4 pl-11 pr-4 outline-none focus:border-[#b58b32]" placeholder="+91 98765 43210" />
                    </div>
                  </div>
                </div>
                <div>
                ...
                <textarea className="min-h-32 w-full border border-black/15 bg-white p-4 outline-none focus:border-[#b58b32]" placeholder="Tell us what you are interested in..." />
